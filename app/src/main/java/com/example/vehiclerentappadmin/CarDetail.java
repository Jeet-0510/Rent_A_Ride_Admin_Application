...
public class CarDetail extends AppCompatActivity {
    ...
    public void uploadData() {
        ...
        FirebaseDatabase.getInstance().getReference("Admin").child(mobileNumber).child("CAR").child(currdate).setValue(carData).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
