...
public class ScooterDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Image = findViewById(R.id.scooter_image);
        saveButton = findViewById(R.id.scooter_save);
        name = findViewById(R.id.scooter_name);
        desc = findViewById(R.id.scooter_desc);
        location = findViewById(R.id.scooter_location);
        Ruppes = findViewById(R.id.scooter_rupees);
        ...
        ActivityResultLauncher<Intent> activityResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
            ...
            public void onActivityResult(ActivityResult result) {
                if (result.getResultCode() == Activity.RESULT_OK) {
                    ...
                    Toast.makeText(ScooterDetail.this, "No Image Selected", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    public void savedata() {
        ...
        if(uri!=null) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(ScooterDetail.this);
    ...
    public void uploadData() {
        ...
        ScooterData scooterData = new ScooterData(Cname, Cdesc, CLocation, Cruppes, url);
        String currdate = DateFormat.getDateTimeInstance().format(Calendar.getInstance().getTime());

        FirebaseDatabase.getInstance().getReference("Admin").child(mobileNumber).child("SCOOTER").child(currdate).setValue(scooterData).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(ScooterDetail.this, "Saved Successful", Toast.LENGTH_SHORT).show();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ScooterDetail.this, e.getMessage().toString(), Toast.LENGTH_LONG).show();
